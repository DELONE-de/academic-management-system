 ...
 * @desc    Authenticate user; returns { user, token } in the response body
 * @access  Public
 */
 ...
 * @desc    Acknowledge logout (stateless JWT — the client discards its token)
 * @access  Public (safe — no server-side session to destroy)
 */
